...
namespace Helper {
    ...
    public:
        ...
        MotorControl(Pin enable, Pin in1, Pin in2, bool inverse, int calibration_offset);
        ~MotorControl();
    ...
    MotorControl::MotorControl(Pin enable, Pin in1, Pin in2, bool inverse=false, int calibration_offset=0): 
        enable(enable),
        in1(in1),
        in2(in2),
        inverse(inverse),
